...
def main():
    ...
    if file1=="-" and file2=="-":
        ...
        fileOpen1=open(file2, 'r')
        initialColumn2=fileOpen1.read().split('\n')
        fileOpen1.close()
        initialColumn1=sys.stdin.read().split('\n')
    elif file1!="-" and file2=="-":
        initialColumn2=sys.stdin.read().split('\n')
        fileOpen2=open(file1, 'r')
        initialColumn1=fileOpen2.read().split('\n')
        fileOpen2.close()
    else:
    ...
    for i in column3:
        if i in initialColumn1:
            initialColumn1.remove(i)
        if i in initialColumn2:
